...
#define SX1272_SS 10
#else
#define SX1272_SS 15      //original 2, for esp8266 15
#endif
...
#define        REG_VERSION	  					0x42 // Agge Version code of the chip. Bits 7-4 give the full revision number. bits 3-0 give the metal mask revision number
...
//FREQUENCY CHANNELS:
// added by Agge.Bitter
const uint32_t CH_00_433 = 0x6C4B33; // channel 0, central freq = 433.175MHz
const uint32_t CH_01_433 = 0x6C5800; // channel 1, central freq = 433.375MHz
const uint32_t CH_02_433 = 0x6C64CD; // channel 2, central freq = 433.575MHz
const uint32_t CH_05_433 = 0x6C8000; // channel 05, central freq = 434.00MHz
//  = FQ_in_Hz*RH_LORA_FCONVERT
...
public:
	...
	/*!  --------------------------------------------- Not Fixed yet ------------------------------------------------------------------
	/*!
	It sets frequency  e module is using.
	It stores in global '_channel' variable the frequency channel
